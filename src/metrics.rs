...
impl Metrics {
    ...
    pub fn record_engagement_seconds(&self, labels: &DimensionLabels, seconds: f64) {
    ...
    pub fn record_custom_property(&self, event_name: &str, key: &str, value: &str) {
        let event_name = sanitize_label(event_name);
